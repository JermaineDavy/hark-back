<template>
    <div class="confetti-container">
        <div v-for="n in 40" class="confetti"></div>

        <div class="h-screen flex items-center justify-center">
            <button @click="resetBoard()" class="bg-sky-800 hover:bg-sky-600 py-4 px-5 text-white font-medium rounded">Restart Game</button>
        </div>
    </div>
...
function resetBoard() {
    const currentBoardSize = trackerStore.boardSize;

    trackerStore.boardSize = 0;
    trackerStore.boardSize = currentBoardSize;
}

onMounted(() => {
    const winAudio = new Audio('/assets/sounds/piglevelwin2mp3-14800.mp3');
